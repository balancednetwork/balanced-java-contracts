...
class LoansIntegrationTestMigration extends LoansIntegrationTest {
    ...
    void updateLoans() throws Exception {
        ...
        Map<String, Object> availableAssetsEdited = new HashMap<>(availableAssetsPreUpdate);
        ...
        for (BalancedClient client : balanced.balancedClients.values()) {
            try {
                Map<String, Object> position = new HashMap<>(reader.loans.getAccountPositions(client.getAddress()));
        ...
        BigInteger balanceAndSupplyTotalDebtPost =
                reader.loans.getBalanceAndSupply("Loans", reader.getAddress()).get("_totalSupply");
    ...
    private void comparePositions(List<Map<String, Object>> positions, List<Map<String, Object>> refPositions) {
        for (int i = 0; i < positions.size(); i++) {
            Map<String, Map<String, Object>> assetsDetails = (Map<String, Map<String, Object>>) positions.get(i).get(
                    "holdings");
            Map<String, Map<String, Object>> standingDetails =
                    (Map<String, Map<String, Object>>) positions.get(i).get("standings");
    ...
    private void liquidateUser() throws Exception {
        ...
        assertEquals(BigInteger.ZERO, loanTaker.loans.getBalanceAndSupply("Loans", loanTaker.getAddress()).get(
                "_balance"));
    }
