 ...
 */
package network.balanced.score.core.loans.mocks.iETH;
...
public class iETHMintBurn extends iETH {

    private final VarDB<Address> minter = Context.newVarDB("minter", Address.class);

    public iETHMintBurn(String _name, String _symbol, int _decimals, BigInteger _totalSupply) {
