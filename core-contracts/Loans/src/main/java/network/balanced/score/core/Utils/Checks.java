...
public class Checks {
    ...
    public static void onlyRewards() {
        Address rewards = Loans.rewards.getOrDefault(defaultAddress);
        Address sender = Context.getCaller();
    ...
    public static void onlyRebalance() {
        Address rebalance = Loans.rebalancing.getOrDefault(defaultAddress);
        Address sender = Context.getCaller();
    ...
    public static void loansOn() {
        Context.require(Loans.loansOn.get(), "Balanced Loans SCORE is not active.");
    }
}