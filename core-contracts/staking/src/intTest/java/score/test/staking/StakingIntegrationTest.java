...
public class StakingIntegrationTest implements ScoreIntegrationTest {
    ...
    private Address stakingAddress = Address.fromString("cx916796da1d86b9fc9d7fe1697239c2d5ca1c4cb1");
...
//    }
    ...
    void testName() throws Exception {
        Assertions.assertEquals("Staked ICX Manager", stakingManagementScore.name());
...
//        PrepDelegations p2=new PrepDelegations();
        ...
        for (String prep : prepDelegations.keySet()){
            prepDelegations.put(prep,prepDelegations.get(prep).add(new BigInteger("1000000000000000000")));
        }
        Assertions.assertTrue(prepDelegations.equals(networkDelegations));
    }
...
//        stakingManagementScore.toggleStakingOn();
        ...
        List<Map<String, Object>> userUnstakeInfo = (List<Map<String, Object>>) stakingManagementScore.getUserUnstakeInfo(senderAddress);
    ...
    void unstakeFull() throws Exception {
        ...
        List<Map<String, Object>> userUnstakeInfo = (List<Map<String, Object>>) stakingManagementScore.getUserUnstakeInfo(Address.fromString("hx8119b3eebeb9f857efb3b135275ac3775cbc6664"));
        Assertions.assertEquals("hx8119b3eebeb9f857efb3b135275ac3775cbc6664",  userUnstakeInfo.get(0).get("sender"));
        Assertions.assertEquals(senderAddress.toString(),  userUnstakeInfo.get(0).get("from"));
        String hexValue = (String) userUnstakeInfo.get(0).get("amount");
        hexValue = hexValue.replace("0x","");
        Assertions.assertEquals(new BigInteger("50000000000000000000"), new BigInteger(hexValue, 16));
...
//        PrepDelegations p2=new PrepDelegations();
        ...
        data.put("method", "unstake");
        sicxScore.transfer(stakingAddress, new BigInteger("10000000000000000000"), data.toString().getBytes());
        ((StakingInterfaceScoreClient)stakingManagementScore).stakeICX(new BigInteger("15000000000000000000"), null, null);
        checkReadonlyFunctions();

    }

    void checkReadonlyFunctions() throws Exception {
        Assertions.assertEquals(new BigInteger("73000000000000000000"), stakingManagementScore.getTotalStake());
        Assertions.assertEquals(new BigInteger("27000000000000000000"), stakingManagementScore.getUnstakingAmount());
        Assertions.assertEquals(sicxClient._address(), stakingManagementScore.getSicxAddress());
        Assertions.assertEquals( new BigInteger("12000000000000000000"), stakingManagementScore.claimableICX(senderAddress));
        Assertions.assertEquals( new BigInteger("3000000000000000000"), stakingManagementScore.claimableICX(Address.fromString("hx8119b3eebeb9f857efb3b135275ac3775cbc6664")));
        Assertions.assertEquals( new BigInteger("15000000000000000000"), stakingManagementScore.totalClaimableIcx());
        Assertions.assertEquals( new BigInteger("23000000000000000000"), sicxScore.balanceOf(senderAddress));
        Assertions.assertEquals( new BigInteger("50000000000000000000"), sicxScore.balanceOf(user2));

        //checks address delegation of a sender
        checkAddressDelegations(senderAddress,"hx24791b621e1f25bbac71e2bab8294ff38294a2c6", new BigInteger("23000000000000000000"));
    ...
    void checkPrepDelegations(String delegatedAddress, BigInteger specificDelegations, BigInteger evenlyDelegation){
        ...
        Assertions.assertTrue(stakingManagementScore.getPrepDelegations().equals(expectedPrepDelegations));
    ...
    void checkFirstUserUnstakeInfo() throws Exception {
        ...
        String hexValue = (String) userUnstakeInfo.get(0).get("amount");
        hexValue = hexValue.replace("0x","");
        Assertions.assertEquals(new BigInteger("10000000000000000000"), new BigInteger(hexValue, 16));
    }
    ...
    void checkSecondUserUnstakeInfo() throws Exception {
        ...
        String hexValue = (String) userUnstakeInfo.get(0).get("amount");
        hexValue = hexValue.replace("0x","");
        Assertions.assertEquals(new BigInteger("7000000000000000000"), new BigInteger(hexValue, 16));
        Assertions.assertEquals("hx8119b3eebeb9f857efb3b135275ac3775cbc6664",  userUnstakeInfo.get(1).get("sender"));
        Assertions.assertEquals(senderAddress.toString(),  userUnstakeInfo.get(1).get("from"));
        String hexVal = (String) userUnstakeInfo.get(1).get("amount");
        hexVal = hexVal.replace("0x","");
        Assertions.assertEquals(new BigInteger("10000000000000000000"), new BigInteger(hexVal, 16));
    }
    ...
    void checkUnstakeInfo() throws Exception {
        ...
        Assertions.assertEquals(new BigInteger("7000000000000000000"), new BigInteger(value, 16));
        List<Object> secondItem = unstakeInfo.get(1);
        Assertions.assertEquals(senderAddress.toString(),  secondItem.get(2));
        Assertions.assertEquals("hx8119b3eebeb9f857efb3b135275ac3775cbc6664",  secondItem.get(4));
        String hexVal = (String) secondItem.get(1);
        hexVal = hexVal.replace("0x","");
        Assertions.assertEquals(new BigInteger("10000000000000000000"), new BigInteger(hexVal, 16));
        List<Object> thirdtItem = unstakeInfo.get(2);
        Assertions.assertEquals(senderAddress.toString(),  thirdtItem.get(2));
        Assertions.assertEquals(senderAddress.toString(),  thirdtItem.get(4));
...
//        PrepDelegations p2=new PrepDelegations();
        ...
        stakingManagementScore.delegate(userDelegation);
        sicxScore.transfer(Address.fromString("hx8119b3eebeb9f857efb3b135275ac3775cbc6664"), new BigInteger("50000000000000000000"), null);
        JSONObject data = new JSONObject();
        data.put("method", "unstake");
        sicxScore.transfer(stakingAddress, new BigInteger("10000000000000000000"), data.toString().getBytes());
        data.clear();
        ...
        sicxScore.transfer(stakingAddress, new BigInteger("10000000000000000000"), data.toString().getBytes());
        ((StakingInterfaceScoreClient)stakingManagementScore).stakeICX(new BigInteger("15000000000000000000"), null, null);
        Assertions.assertEquals(new BigInteger("146000000000000000000"), stakingManagementScore.getTotalStake());
        Assertions.assertEquals(new BigInteger("27000000000000000000"), stakingManagementScore.getUnstakingAmount());
        Assertions.assertEquals(sicxClient._address(), stakingManagementScore.getSicxAddress());
        Assertions.assertEquals( new BigInteger("34000000000000000000"), stakingManagementScore.claimableICX(senderAddress));
        Assertions.assertEquals( new BigInteger("23000000000000000000"), stakingManagementScore.claimableICX(Address.fromString("hx8119b3eebeb9f857efb3b135275ac3775cbc6664")));
        Assertions.assertEquals( new BigInteger("57000000000000000000"), stakingManagementScore.totalClaimableIcx());
        Assertions.assertEquals( new BigInteger("46000000000000000000"), sicxScore.balanceOf(senderAddress));
        Assertions.assertEquals( new BigInteger("50000000000000000000"), sicxScore.balanceOf(user2));
        Assertions.assertEquals( new BigInteger("50000000000000000000"), sicxScore.balanceOf(Address.fromString("hx8119b3eebeb9f857efb3b135275ac3775cbc6664")));

        checkAddressDelegations(senderAddress,"hx3c7955f918f07df3b30c45b20f829eb8b4c8f6ff", new BigInteger("46000000000000000000"));
        checkFirstUserUnstakeInfo();
        checkSecondUserUnstakeInfo();
        checkUnstakeInfo();
        checkPrepDelegations("hx3c7955f918f07df3b30c45b20f829eb8b4c8f6ff",new BigInteger("47000000000000000000"),new BigInteger("1000000000000000000" ));
    }
