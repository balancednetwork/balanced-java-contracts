...
public class RewardsImpl {
    ...
    public void tokenFallback(Address _from, BigInteger _value, byte[] _data) {
        ...
        Context.require(externalRewardTokens.get(token), "Only whitelisted tokens is allowed as rewards tokens");
        Context.require(externalRewardProviders.get(_from), "Only whitelisted addresses is allowed to provider external rewards");
