...
public class Consts {
    ...
    public static BigInteger MINIMUM_ELIGIBLE_DEBT = BigInteger.valueOf(50).multiply(BigInteger.TEN.pow(18));
    ...
    public static BigInteger U_SECONDS_DAY = BigInteger.valueOf(86400).multiply(BigInteger.TEN.pow(18));
}
