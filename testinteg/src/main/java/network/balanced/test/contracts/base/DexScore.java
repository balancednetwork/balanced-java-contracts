...
public class DexScore extends Score {
    private static final String PYTHON_PATH = "../../testinteg/src/main/java/network/balanced/test/contracts/base/pythonContracts/dex.zip";
    
    public static DexScore deploy(TransactionHandler txHandler, Wallet wallet, Address governaceAddress)
        ...
        return new DexScore(score);
    }

    public DexScore(Score other) {
        super(other);
    }
}