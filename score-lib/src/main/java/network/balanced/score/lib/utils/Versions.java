...
public class Versions {
    ...
    public final static String LOANS = "v1.2.0.1";
    ...
    public final static String REWARDS = "v1.2.0";
    ...
    public final static String ROUTER = "v1.1.5";
    ...
    public final static String BALANCED_ASSETS = "v1.0.0.1";
